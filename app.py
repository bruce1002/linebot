...
tokenizer = AutoTokenizer.from_pretrained("oktrained/llama-3.1-0.5B-Untrained")
llm_model = AutoModelForCausalLM.from_pretrained("oktrained/llama-3.1-0.5B-Untrained").to(torch.device("cuda" if torch.cuda.is_available() else "cpu"))
